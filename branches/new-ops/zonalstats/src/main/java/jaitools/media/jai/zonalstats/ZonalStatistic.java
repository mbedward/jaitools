...
/**
 * Constants for the statistics supported by {@linkplain ZonalStatsOpImage}
 * 
 * @author Michael Bedward
 */
public enum ZonalStatistic {
    ...
    private static Map<String, ZonalStatistic> lookup;
    static {
        lookup = new HashMap<String, ZonalStatistic>();
        for (ZonalStatistic stat : ZonalStatistic.values()) {
     ...
     * Private constructor
     */
    private ZonalStatistic(String name, String desc, boolean supportsIntResult) {
        this.name = name;
        this.desc = desc;
    ...
    /**
     * Get a ZonalStatistic constant by name. A case-insensitive
     * lookup is performed.
     * @param name the statistic name
     * @return a ZonalStatistic instance or null if the name was
     * not recognized
     */
    public static ZonalStatistic get(String name) {
