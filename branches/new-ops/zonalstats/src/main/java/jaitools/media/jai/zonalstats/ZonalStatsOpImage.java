 ...
 */
final class ZonalStatsOpImage extends PointOpImage {
    ...
    public ZonalStatsOpImage(RenderedImage dataImage, RenderedImage zoneImage,
        ...
        super(dataImage, zoneImage, layout, config, false);
    ...
    private static class Calculator {
         ...
         * @param stat the {@linkplain ZonalStatistic} constant for the desired statistic
         * @param data the sample data
         * @param n number of elements to use from the sample data array
         * @return value of the statistic as a double (may be NaN)
         */
        public double call(ZonalStatistic stat, Double[] data, int n) {
            Double[] values = null;
            if (data.length == n) {
                values = data;
            } else {
