...
/**
 * OperationRegistrySpi implementation to register the "FloodFill"
...
public class FloodFillSpi implements OperationRegistrySpi {
    ...
    private String productName = "jaitools.media.jai.floodfill";
 
    /** Default constructor. */
    public FloodFillSpi() {}

    /**
     * Registers the FloodFill operation and its
    ...
    public void updateRegistry(OperationRegistry registry) {
        OperationDescriptor op = new FloodFillDescriptor();
        registry.registerDescriptor(op);
        String descName = op.getName();
        
        RenderedImageFactory rif = new FloodFillRIF();
