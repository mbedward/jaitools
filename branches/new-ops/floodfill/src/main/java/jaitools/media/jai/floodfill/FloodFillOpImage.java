...
/**
 * For each of a set of starting points (pixel locations) and cooresponding integer
 * values, this operator flood-fills all pixels connected to the starting point,
 * setting them to the value specified for that point.
 *
...
public class FloodFillOpImage extends PointOpImage {
     ...
     * @see FloodFillDescriptor
     */
    public FloodFillOpImage(RenderedImage source,
            Map config,
            ImageLayout layout,
            int band,
            double tolerance,
