...
/**
 * Describes the "FloodFill" operation.
 * <p>
 ...
 * {@linkplain FloodFillDescriptor#REGION_DATA_PROPERTY}).
 * <p>
 *
 * <b>Parameters</b>
 * <table border="1">
...
public class FloodFillDescriptor extends OperationDescriptorImpl {
    ...
    /** Constructor. */
    public FloodFillDescriptor() {
        super(new String[][]{
                    {"GlobalName", "FloodFill"},
                    {"LocalName", "FloodFill"},
                    {"Vendor", "jaitools"},
                    {"Description", "Identifies sufficiently uniform regions in a source image"},
                    {"DocURL", "http://code.google.com/p/jai-tools/"},
                    {"Version", "0.0.1"},
                    {"arg0Desc", "band (int) - the band to floodfill"},
     ...
     * invokes {@code JAI.create("floodfill", params) }.
    ...
    public static RenderedOp create(
        ...
        ParameterBlockJAI pb =
                new ParameterBlockJAI("FloodFill",
        ...
        return JAI.create("FloodFill", pb, hints);
    }
}
